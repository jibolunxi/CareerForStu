		...
		<section class="aui-scrollView">
			...
			<div style="margin-top: 4rem; text-align: center"
				...
				<c:if test="${isFriend == 0}">
					<p>
						<a id="friend"
							style="background-color: #FFFF00; border: none; color: white; padding: 0.5rem 2rem; text-align: center; text-decoration: none; display: inline-block; font-size: 16px; cursor: pointer; margin-top: 2rem;">已发送请求</a>
					</p>
				</c:if>
				<c:if test="${isFriend > 1}">
					<p>
