    ...
    <section class="aui-scrollView" >
        ...
        <div style="margin-top: 4rem;text-align: center" class="friend-detail">
            ...
            <c:if test="${isFriend == 1}">
   				<p><a href="removeFriends" onclick="success()" id="friend" style="background-color: #FF0000;border: none;color: white;padding: 0.5rem 2rem;text-align: center;text-decoration: none;display: inline-block;font-size: 16px;cursor: pointer;margin-top:2rem;">删除好友</a></p>
			</c:if>
			<c:if test="${isFriend == 0}">
   				<p><a id="friend" style="background-color: #FFFF00;border: none;color: white;padding: 0.5rem 2rem;text-align: center;text-decoration: none;display: inline-block;font-size: 16px;cursor: pointer;margin-top:2rem;">已发送请求</a></p>
			</c:if>
			<c:if test="${isFriend > 1}">
   				<p><a href="sendFriendsRequest" onclick="success()" id="friend" style="background-color: #4CAF50;border: none;color: white;padding: 0.5rem 2rem;text-align: center;text-decoration: none;display: inline-block;font-size: 16px;cursor: pointer;margin-top:2rem;">加为好友</a></p>
			</c:if>
        </div>
