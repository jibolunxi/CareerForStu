            ...
            <div class="aui-code-box">
                <form action="studentHomePage" method="post">
                    <p class="aui-code-line">
                        <input type="text" class="aui-code-line-input" name="studentName" value="" id="studentName" autocomplete="off" placeholder="请输入账户姓名">
                    </p>
                    <p class="aui-code-line aui-code-line-clear">
                        <input type="password" class="aui-code-line-input password" name="password" value="" id="password" placeholder="请输入密码">
                    </p>
