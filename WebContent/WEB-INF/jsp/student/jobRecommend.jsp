...
<section class="aui-flexView">
    <header class="aui-navBar aui-navBar-fixed b-line">
        ...
        <div class="aui-center">
            ...
            <span style="color:whitesmoke;position:fixed;width:100%;text-align:center;right:0;left:0;font-size:1.35rem; top:1.25rem">工作推荐</span>
            </span>
        </div>
	 ...
	 <section class="aui-scrollView">
	        <div class="aui-users-list">
	            <c:forEach var="companyJob" items="${companyJobs}">
			            <a href="jobRecommendDetail?companyJobId=${companyJob.id}" class="aui-flex b-line">
			                <div class="aui-flex-box">
			                    ...
			                    <label class="detail"><img src="images/talk.png" width="20px" height="20px"><span>${companyJob.jobhits}</span></label>
			                    <label class="detail"><img src="images/view.png" width="20px" height="20px"><span>${companyJob.snum}</span></label>	                  
			                </div>
			                <div class="aui-user-button" style="text-align: center ">
			                    <span style="display: inline-block;vertical-align: middle"><img src="images/arrow.png" width="25px"height="25px"></span>
			                </div>
			            </a>
	           </c:forEach>
	        </div>
    ...
    <footer class="aui-footer">
        ...
        <a href="studentZone" class="aui-tabBar-item">
                    <span class="aui-tabBar-item-icon">
