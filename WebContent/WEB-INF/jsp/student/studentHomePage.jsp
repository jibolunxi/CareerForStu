...
<body>
    ...
    <section class="aui-flexView">
        <header class="aui-navBar aui-navBar-fixed b-line">
            ...
            <span style="color:whitesmoke;position:fixed;width:100%;text-align:center;right:0;left:0;font-size:1.35rem; top:1.25rem">学校通知</span>
            </span>
        	</div>
        </header>
        <section class="aui-scrollView">
            ...
            <div>
                <img src="images/gonggao.jpg" class="gonggao">
                <a href="newsList" class="gengduo">更多</a>
                <a href="newsDetail?newsId=${homepage_news.id}">
	                <div class="tongzhi">
            ...
            <c:forEach var="homepage_student" items="${homepage_students}">
                <a href="studentDetail?studentId=${homepage_student.uid}" class="aui-flex b-line">
                    <div class="aui-flex-user">
                        <img src="images/user.jpg" alt="">
                    </div>
                    <div class="aui-flex-box">
                        <h2>${homepage_student.name}</h2>
                        <p>${homepage_student.college_name} &nbsp;${homepage_student.dept_name}</p>
