    ...
    <section class="aui-flexView">
        <header class="aui-navBar aui-navBar-fixed b-line">
            <a href="#" class="aui-navBar-item">
                <!-- <i class="icon icon-return" onclick="sure()" id="return_back" style="z-index: 1000"></i> -->
        ...
        <section class="aui-scrollView">
             <c:forEach var="college" items="${colleges}">
                ...
                <a href="collegeReturnHome?collegeId=${college.id}&collegeName=${college.name}" class="aui-flex">
