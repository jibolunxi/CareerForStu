	...
	<section class="aui-flexView">
		<header class="aui-navBar aui-navBar-fixed b-line">
			<div class="aui-navBar-item">
				<a class="icon icon-return" href="jobRecommend"></a> <span
					style="color: whitesmoke" class="fixed">${companyJob.name}</span>
			</div>
			<c:if test="${isStar==0}">
				<a href="addCollection"
					style="position: absolute; right: 1rem; top: 1.6rem; z-index: 10000">
					<img src="images/Star.png" width="20px" height="20px" id="Star">
				</a>
			</c:if>
			<c:if test="${isStar==1}">
				<a href="removeCollection"
					style="position: absolute; right: 1rem; top: 1.6rem; z-index: 10000">
			...
			<div class="aui-users-list">
				<a href="#" class="aui-flex b-line">
					<div class="aui-flex-box">
						<h1 style="font-size: 1.6rem">${companyJob.name}
							<span class="type_state">招聘中</span>
						</h1>
						<p style="font-size: 1.2rem">${companyJob.minsalary}-${companyJob.maxsalary}</p>
						<br> <label class="detail"><img src="images/home.png"
					...
					<div class="aui-flex-box">
						...
						<p style="font-size: 1rem; color: black">${companyJob.description}<span
								style="position: absolute; right: 1rem"><img
								src="images/arrow.png" width="17px" height="17px"> </span>
						</p>
						<p class="detail" style="font-size: 1.1rem; color: black">任职要求</p>
						<p style="font-size: 1rem; color: black">${companyJob.cert}<span
								onclick="#" style="color: #4c7ee9">查看详情</span><span
								style="position: absolute; right: 1rem"><img
								src="images/arrow.png" width="17px" height="17px"> </span>
						</p>
					...
					<div class="aui-flex-box">
						...
						<span class="type" style="font-size: 1rem">UI</span> <span
							class="type" style="font-size: 1rem">数据库</span>
					</div>
