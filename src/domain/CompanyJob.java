...
public class CompanyJob {
	...
	public void setHy_id(int hy_id) {
		this.hy_id = hy_id;
	}
	...
	public int getJob3_id() {
		return job3_id;
	}
	public void setJob3_id(int job3_id) {
		this.job3_id = job3_id;
	}
	public String getJob3_name() {
		return job3_name;
	}
	public void setJob3_name(String job3_name) {
		this.job3_name = job3_name;
	}
	...
	public void setThree_cityid(int three_cityid) {
		this.three_cityid = three_cityid;
	}
	public String getThree_cityname() {
		return three_cityname;
	}
	public void setThree_cityname(String three_cityname) {
		this.three_cityname = three_cityname;
	}
	...
	public int getIs_targeted() {
		return is_targeted;
	}
	public void setIs_targeted(int is_targeted) {
		this.is_targeted = is_targeted;
	}
